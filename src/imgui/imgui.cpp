...
static const int AREA_HEADER = 14;
...
bool imguiBeginScrollArea(const char* name, int x, int y, int w, int h, int* scroll)
{
        ...
        addGfxCmdRoundedRect((float)x, (float)y, (float)w, (float)h, 6, imguiRGBA(255,255,255,192));

        addGfxCmdText(x+AREA_HEADER/2, y+h-AREA_HEADER/2-TEXT_HEIGHT/2, IMGUI_ALIGN_LEFT, name, imguiRGBA(255,196,0,192));
...
void imguiLabel(const char* text)
{
        ...
        addGfxCmdText(x, y+BUTTON_HEIGHT/2-TEXT_HEIGHT/2, IMGUI_ALIGN_LEFT, text, imguiRGBA(215,215,115,255));
}
